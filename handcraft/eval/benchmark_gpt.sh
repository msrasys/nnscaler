...
python -m torch.distributed.launch \
    ...
    --master_port=8004 \
    --use_env \
    examples/gpt/gpt.py > /mydata/MagicCube/expdata/8B.2V100.Cube.txt
...
python -m torch.distributed.launch \
    ...
    --master_port=8004 \
    --use_env \
    examples/gpt/gpt.py > /mydata/MagicCube/expdata/8B.4V100.Cube.txt
...
python -m torch.distributed.launch \
    ...
    --master_port=8004 \
    --use_env \
    examples/gpt/gpt.py > /mydata/MagicCube/expdata/8B.8V100.Cube.txt

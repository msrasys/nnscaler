...
class DecoderLayer(torch.nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, ffn_embed_dim: int,
        ...
        self.self_attn = MultiHeadSelfAttention(embed_dim, num_heads, atten_dropout)

        self.cross_attn_layer_norm = torch.nn.LayerNorm(embed_dim)
        self.cross_attn = MultiHeadCrossAttention(embed_dim, num_heads, atten_dropout)

    ...
    for param_group in param_groups:
        ...
        try:
            ...
            if valid_edges:
                ...
                # NOTE from nnscaler: this is the only difference from the original stage_backward_weight,
                # which is to use torch.autograd.backward instead of
                # manually accumulating gradients into weight.grad

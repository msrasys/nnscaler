...
def wrap_ring_attn_varlen_func(
    ...
    """Run variable-length attention with optional ring context parallelism.
    ...
    Args:
        ...
        window_size: Left and right sliding-window sizes; ``(-1, -1)`` disables it.
        ...
        enable_ring: Whether context-parallel ring attention is enabled.

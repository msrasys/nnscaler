...
from benchmark_parallel_utils import (BenchmarkCase, ShardParallelArgs,
                                      UniformParallelArgs)
...
def benchmark_suite(suite_name,
    ...
    for benchmark_case in suite:
        ...
        if shard_only:
            ...
            benchmark_case_new = BenchmarkCase(
                input_batch_size,
                GPTModelConfig(1024, 4096, input_gpt_layer, 32, 51200),
                input_micro_batches, 'uniform',
                UniformParallelArgs(reduce_scatter, recomputation, dp, op, 1,
                                    True))

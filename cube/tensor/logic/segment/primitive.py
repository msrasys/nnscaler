"""
This is the primitive to describe the layout requirement.

The primitive translates the requirement before runtime to the 
actual community groups during the runtime
"""
